        ...
        <div className="max-w-[1400px] mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 font-mono text-sm uppercase tracking-wider w-full sm:w-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <a href="https://github.com/Shreyanshdixit6206" target="_blank" rel="noreferrer" className="flex items-center justify-center px-8 py-6 border border-[#333] text-ash group-hover:border-[#050505] group-hover:text-[#050505] transition-colors hover:bg-[#050505] hover:text-white">
                Inspect the Code
              </a>
              <a href="https://drive.google.com/file/d/1QboM0PM15xVvklo6ee3AEQha9h-goaO7/view?usp=sharing" target="_blank" rel="noreferrer" className="flex items-center justify-center px-8 py-6 border border-[#333] text-ash group-hover:border-[#050505] group-hover:text-[#050505] transition-colors hover:bg-[#050505] hover:text-white">
                Read the Resume
              </a>
            </div>
          </div>
